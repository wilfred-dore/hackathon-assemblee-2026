# language: fr
Fonctionnalité: Pas de citation inventée
  La garantie du Rapporteur : chaque article cité existe dans les sources,
  sinon la réponse est un refus explicite.
  ...
  Scénario: Citation vérifiée dans les sources
    ...
    Alors chaque article cité doit exister dans Canutes/Légifrance
